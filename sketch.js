...
//Create a sprite for Invisible ground and place it at the bottom side of the screen.
  kangaroo = createSprite(200,250,10,10);
  kangaroo.addAnimation("kangaroo",kangaroo_running);
  kangaroo.addAnimation("kangarooO",kangaroo_collided);
  kangaroo.scale=0.2;
  kangaroo.setCollider("circle",0,0,300);

  invisibleGround=createSprite(400,340,1000,15);
...
//In function draw(), Set the x-Position of the kangaroo according to the camera
  ...
  if (gameState===PLAY){
    ...
    kangaroo.changeAnimation("kangarooO",kangaroo_collided);
